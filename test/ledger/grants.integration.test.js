...
async function create_promotion(type, platform, active) {
...
test('grants: fetch available promotions', async t => {
  const androidPromotion = await create_promotion("ugp", "android", true)
  ...
  await create_promotion("ugp", "android", false)
  ...
  await create_promotion("ugp", "", true)
